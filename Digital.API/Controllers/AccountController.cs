...
namespace Digital.API.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        {
            var result =  _userManager.Users.Select(x => new { Email = x.Email, Name = x.Name, LastName = x.LastName, ID = x.Id }).ToList();
            return Ok(result);
        }
        ...
        {
            var result = _userManager.Users.Select(x => new { Email = x.Email, Name = x.Name, LastName = x.LastName, ID = x.Id }).ToList().First();
            return Ok(result);
        }
